...
if [ "$#" -eq 0 ]; then
    ...
    echo "$0"
    echo "  def:      Set the configuration file - Equivalent to 'make chipsee_CS10600RA4070P_defconfig'"
...
OUTPUT_DIR=/workspace/outputs/chipsee/cs10600ra4070p
CCACHE_LIMIT="50G"
...
DOCKER_RUN="docker run
    ...
    -v $(pwd)/images/chipsee/cs10600ra4070p:$OUTPUT_DIR/images
    -v $(pwd)/target/chipsee/cs10600ra4070p:$OUTPUT_DIR/target
    -v $(pwd)/graphs/chipsee/cs10600ra4070p:$OUTPUT_DIR/graphs
